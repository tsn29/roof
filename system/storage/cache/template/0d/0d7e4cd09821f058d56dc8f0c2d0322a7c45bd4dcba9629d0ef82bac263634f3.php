...
class __TwigTemplate_53f4060b7e67086920df24d8ae45c71baa21ab1b379a1de430904faf6a865aec extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<?if(\$b['link']!=''){?>
\t\t\t\t\t\t<a href=\"<?echo \$b['link']?>\"><img src=\"<?echo \$b['image']?>\" alt=\"<? echo \$b['title']?>\"></a>
\t\t\t\t\t\t<?} else {?>
\t\t\t\t\t\t\t<img src=\"<? echo \$b['image']?>\" alt=\"<? echo \$b['title']?>\">
\t\t\t\t\t\t<?}?>
\t\t\t\t\t\t</div>
\t\t\t\t\t<?}?>
