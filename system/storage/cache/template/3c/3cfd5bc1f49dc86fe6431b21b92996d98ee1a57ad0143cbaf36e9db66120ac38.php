...
class __TwigTemplate_c214c2a5b51ec9d43ce318a0cb66102b7b3c6b17fd27ad2fc439c721e05dd86d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<img class=\"footer__logo-img\" src=\"/catalog/view/theme/shop/assetsimg/logo-white.png\" alt=\"\">
\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t<img src=\"/catalog/view/theme/shop/assetsimg/icons/social/instagram-white.svg\" alt=\"\">
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t<a class=\"social-links__link\" href=\"https://www.facebook.com/\" target=\"_blank\">
\t\t\t\t\t\t\t\t<img src=\"/catalog/view/theme/shop/assetsimg/icons/social/facebook-white.svg\" alt=\"\">
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t<a class=\"social-links__link\" href=\"https://www.youtube.com/\" target=\"_blank\">
\t\t\t\t\t\t\t\t<img src=\"/catalog/view/theme/shop/assetsimg/icons/social/youtube-white.svg\" alt=\"\">
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</div>
...
\t\t\t\t\t\t\t<img class=\"footer__company-img\" src=\"/catalog/view/theme/shop/assetsimg/footer-companies/terrawood.png\" alt=\"\">
\t\t\t\t\t\t\t<img class=\"footer__company-img footer__company-img--hover\"
\t\t\t\t\t\t\t\tsrc=\"/catalog/view/theme/shop/assetsimg/footer-companies/terrawood-hover.png\" alt=\"\">
\t\t\t\t\t\t</a>
\t\t\t\t\t\t<a class=\"footer__company\" href=\"#\">
\t\t\t\t\t\t\t<img class=\"footer__company-img\" src=\"/catalog/view/theme/shop/assetsimg/footer-companies/noblex.png\" alt=\"\">
\t\t\t\t\t\t\t<img class=\"footer__company-img footer__company-img--hover\"
\t\t\t\t\t\t\t\tsrc=\"/catalog/view/theme/shop/assetsimg/footer-companies/noblex-hover.png\" alt=\"\">
\t\t\t\t\t\t</a>
\t\t\t\t\t\t<a class=\"footer__company\" href=\"#\">
\t\t\t\t\t\t\t<img class=\"footer__company-img\" src=\"/catalog/view/theme/shop/assetsimg/footer-companies/metrotile.png\" alt=\"\">
\t\t\t\t\t\t\t<img class=\"footer__company-img footer__company-img--hover\"
\t\t\t\t\t\t\t\tsrc=\"/catalog/view/theme/shop/assetsimg/footer-companies/metrotile-hover.png\" alt=\"\">
\t\t\t\t\t\t</a>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t<img class=\"popup-form__logo\" src=\"/catalog/view/theme/shop/assetsimg/logo.png\" alt=\"\">
